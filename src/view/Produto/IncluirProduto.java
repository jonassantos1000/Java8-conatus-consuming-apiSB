...
public class IncluirProduto extends javax.swing.JFrame {
    ...
    public IncluirProduto(User usuarios) {
        initComponents();
        user = usuarios;
        setValue();
        setMask();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 140, 40, 20));
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        try {
            if ("".equals(txtDescricao.getText())) {
                ...
                Product prod = new Product(codigo, descricao, preco, data,"", usuario, observacao, cbInativo);
...
private void setMask() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncluirProduto.class
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IncluirProduto().setVisible(true);
            }
        });
    }
