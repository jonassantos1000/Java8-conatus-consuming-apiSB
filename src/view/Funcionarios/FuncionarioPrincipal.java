...
public class FuncionarioPrincipal extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FuncionarioPrincipal
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(btAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 550, 150, 50));
        ...
        getContentPane().add(btIncluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(707, 550, -1, 50));
        ...
        btCancelar1.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        ...
        getContentPane().add(btCancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 550, 140, 50));
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        try {
            ...
            AlterarFuncionario alterar = new AlterarFuncionario(obj.toString());
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            ...
            for (Employee func : select) {
                String codigoformat;
                codigoformat = String.valueOf(func.getCodigo());
                modelo.addRow(new Object[]{codigoformat, func.getNome(), func.getCpf(), func.getRg(), func.getEndereco(), func.getEmail(), func.getCelular(), data.formataDataBD(func.getData_alteracao()), data.formataDataBD(func.getData_cadastro())});
            }
            if (lenlist.equals("1")) {
    ...
    private void btCancelar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelar1ActionPerformed
        try {
            String codFuncionarioSelecionado = grid.getValueAt(grid.getSelectedRow(), 0).toString();
            String nomeFuncionarioSelecionado = grid.getValueAt(grid.getSelectedRow(), 1).toString();
            int confirmacao = JOptionPane.showConfirmDialog(null, "Deseja excluir o funcionario selecionado ? \n Funcionario: " + codFuncionarioSelecionado + " | " + nomeFuncionarioSelecionado, "**** Atenção ****", 1);

            if (confirmacao == 0) {
                int cod = Integer.parseInt(codFuncionarioSelecionado);
                EmployeeService.delete(cod);
            }
            btPesquisar.doClick();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FuncionarioPrincipal().setVisible(true);
            }
        });
    }
